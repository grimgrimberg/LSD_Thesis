...
| --- | --- | ---: | ---: | --- |
| Motion and confounds | implemented_design_and_module_dvars_controls_missing_fd_motion | false | 0.55 | Run/session/global-signal and module-DVARS/censoring proxy controls are implemented, but fMRIPrep FD motion summaries are unavailable. |
