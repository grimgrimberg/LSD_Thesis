...
from .requirements import _gate, _requirement
from .status import (
    MINIMUM_PAIRED_MOTION_CONTROL_ROWS,
    REQUIRED_MOTION_CONTROL_FEATURE_FAMILIES,
    REQUIRED_NEUROMAPS_MAP_FAMILIES,
    ROCKET_MINIMUM_BALANCED_ACCURACY,
    ROCKET_MINIMUM_ROC_AUC,
    _evidence_paths,
    _external_scoring_lock_details_verified,
    _int_payload_value,
    _motion_feature_family_coverage,
    _optional_float,
    _read_json,
    _readiness_snapshot,
    _rel,
    _status_is_implemented,
)
...
def _motion_gate(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "fmriprep_motion_preflight_ready": fmriprep_plan_ready,
        "fmriprep_motion_preflight_path": _rel(fmriprep_plan_path, repo_root),
        "fmriprep_motion_preflight_status": fmriprep_plan_status or None,
        "fmriprep_motion_preflight_blocker": fmriprep_plan_payload.get("blocker"),
        "fmriprep_motion_preflight_next_action": fmriprep_plan_payload.get("next_action"),
