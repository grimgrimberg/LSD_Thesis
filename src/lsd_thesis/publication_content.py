    ...
    if cv5_validation:
        ...
        if cv5_validation.get("held_out_validation_completed") is True:
            return (
                ...
                "n=3 held-out subjects per fold require cautious interpretation. The split itself "
                "was not stratified by subject-level fMRIPrep FD/DVARS/confound/censoring; the "
                "image-derived motion/QC sensitivity layer is reported separately. "
