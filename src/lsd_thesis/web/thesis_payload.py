    ...
    return {
        ...
        "uncertainty_gate_rows": [
            ...
            },
            {
                ...
                "claim_status": "mixed" if spatial_ready else "blocked",
            },
        ],
        "claim_tiers": [
            {
            ...
            },
            {
                ...
                "status": "unsupported" if map_claim_ready else "future",
    ...
    payload: dict[str, Any] = {
        ...
        "loop_steps": [
            ...
            },
            {
                ...
                "dashboard_output": "LSD-vs-psilocybin mechanism-proxy ranking comparison with negative/partial outcomes retained.",
            },
            {
                "step": "4",
