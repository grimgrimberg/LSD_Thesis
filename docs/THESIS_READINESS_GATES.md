...
| Canonical parcellation | Schaefer/Yeo extraction reproduces or falsifies the current 8-module conclusions. | `schaefer_100_yeo_7` is the primary canonical layer, with extraction, empirical viewer, and mechanism-ranking summary present and checked for non-empty subject/run/module/ranking content; 8-module remains proxy baseline. |
