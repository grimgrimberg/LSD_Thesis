...
2. Continue splitting the remaining DMDc and network-control-energy concerns out of `src/lsd_thesis/dynamic_mechanism.py` behind public helper interfaces.
