...
ROUTE_DESCRIPTIONS: tuple[tuple[str, str], ...] = (
    ...
    ("/submission", "supervisor submission page with dashboard-derived insights"),
    ("/api/dashboard-data", "dashboard payload with simulation, evidence, provenance, and artifact links"),
    ("/figures", "publication figure-deck page with source, formula, caveat, and export metadata"),
...
REQUIRED_PATHS: tuple[str, ...] = (
    ...
    "src/lsd_thesis/templates/pages/figures.html",
